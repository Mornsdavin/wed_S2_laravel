...
<div class="d-flex flex-column  gap-4 ">
  <nav class="navbar bg-body-tertiary  ">
    <div class="container-fluid">
      <span class="text-secondary navbar-brand mb-0 h1 rounded-2 ">Slide Show</span>
    </div>
  </nav>
      ...
      @if ($product->id < 4)
        ...
        <td style="text-align: center; vertical-align: middle;">
          @foreach ($product_imgs as $img)
                ...
                <img src="{{ '/assets/' . $img->product_img }}" alt="" width="400px" height="120px">
                @endif
          @endforeach
        </td>
...
<div class="d-flex flex-column  gap-4 ">
  <nav class="navbar bg-body-tertiary  ">
    <div class="container-fluid">
      <span class="text-secondary navbar-brand mb-0 h1 rounded-2 ">Product</span>
    </div>
  </nav>
  <table class="table table-bordered" >
